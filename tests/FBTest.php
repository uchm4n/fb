...
class FBTest extends \Orchestra\Testbench\TestCase
{
    ...
    {
        $app['config']->set('services.firebase.database_url', 'https://copart-f335a.firebaseio.com');
        $app['config']->set('services.firebase.secret', 'KB2xZjJgAvmVyB1hWr0RT8ykNrT6f2emuuaxJTr9');
    }
